...
CLI:
    python init.py 美的集团
    python init.py 000333
    python init.py 000333.SZ 600519.SH        # 批量
    python init.py 美的集团 --force            # 全量重拉重下重洗
    python init.py 000333.SZ --no-markdown     # 仅下载 PDF 不抽 Markdown
"""
...
from clean import approved_override_count, default_overrides_path
